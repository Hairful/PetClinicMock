      ...
      <header
        ...
        <div data-thq="thq-navbar-nav" class="register-desktop-menu">
          ...
          <div class="register-buttons">
            <RouterLink to="/login">
              <button class="register-login buttonFilled">Login</button>
            </RouterLink>
      ...
      <div class="register-hero1 heroContainer">
        <div class="register-container1">
          <h1 class="register-hero-heading heading1">
            <span>
              REGISTER For
              <span v-html="rawulkb"></span>
            </span>
            <br />
            <span>A BRAND NEW Experience</span>
          </h1>
          <span class="register-hero-sub-heading bodyLarge">
            <span>
              <span>
                <span>Caring for your furry friends</span>
                <span><span v-html="rawlsi1"></span></span>
              </span>
              <span>
                <span><span v-html="rawa8pc"></span></span>
                <span><span v-html="rawi3da"></span></span>
              </span>
            </span>
            <span>
              <span>
                <span><span v-html="rawh6sk"></span></span>
                <span><span v-html="rawxia7"></span></span>
              </span>
              <span>
                <span><span v-html="rawclhj"></span></span>
                <span><span v-html="raw7h3g"></span></span>
              </span>
            </span>
          </span>
        </div>
        <form class="register-form">
          ...
          />
          <button class="register-register2 buttonFilled">Register</button>
        </form>
      </div>
    </div>
      ...
      <footer class="register-footer1 footerContainer">
        <div class="register-container2">
          ...
          <nav class="register-nav1">
            <span class="register-nav122">Home</span>
            <span class="register-nav322 bodySmall">Our Team</span>
            <span class="register-nav422 bodySmall">Contact</span>
          </nav>
        </div>
        <div class="register-separator"></div>
        <div class="register-container3">
          <span class="bodySmall register-text17">
