<template>
  <div class="register-container">
    <div class="register-header">
      <header data-thq="thq-navbar" class="navbarContainer register-navbar-interactive">
      ...
      <div class="register-hero1 heroContainer">
        ...
        <el-form :model="formLogin" class="register-form" method="get" :rules="rules" ref="formLogin">
          ...
          <el-form-item prop="password" class="register-textinput">
            <el-input prop="password" type="password" placeholder="请输入密码" show-password autocomplete="false"
              v-model="formLogin.password" />
          </el-form-item>
          <el-form-item prop="repeat_password" class="register-textinput">
            <el-input prop="repeat_password" type="repeat_password" placeholder="请重复输入密码" show-password
              autocomplete="false" v-model="formLogin.repeat_password" />
          </el-form-item>
          <table>
            <tr>
              <td>
                <el-input class="register-validcode" type="text" placeholder="请输入验证码" v-model="formLogin.code" />
              </td>
