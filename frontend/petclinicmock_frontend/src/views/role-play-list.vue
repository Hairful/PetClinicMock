<template>
  <div class="role-play-list-container">
    <div class="role-play-list-header">
      ...
      >
        ...
        <div
          ...
          class="role-play-list-mobile-menu1 mobileMenu"
        >
          <div class="role-play-list-nav">
            <div class="role-play-list-top">
              <span class="logo">PETSCLINIC</span>
              <div data-thq="thq-close-menu" class="role-play-list-close-menu">
                <svg
                  viewBox="0 0 1024 1024"
                  class="role-play-list-icon02 socialIcons"
                >
                  <path
            ...
            <nav class="role-play-list-links">
              <span class="role-play-list-nav12 bodySmall">Home</span>
              <span class="role-play-list-nav22 bodySmall">Services</span>
              <span class="role-play-list-nav32 bodySmall">Our Team</span>
              <span class="role-play-list-nav42 bodySmall">Contact</span>
            </nav>
            <div class="role-play-list-buttons">
          ...
          <div>
            <svg
              ...
              class="role-play-list-icon04 socialIcons"
            >
              <path
            ...
            ><svg
              ...
              class="role-play-list-icon06 socialIcons"
            >
              <path
            ...
            ><svg
              ...
              class="role-play-list-icon08 socialIcons"
            >
              <path
    ...
    <div class="heroContainer role-play-list-hero">
      <div class="role-play-list-container2">
        <h1 class="role-play-list-hero-heading">
          <span class="heading1">
            Role Play:
            <span v-html="rawulc0"></span>
          </span>
          <span class="role-play-list-text04">Front Desk</span>
        </h1>
        <span class="role-play-list-hero-sub-heading bodyLarge">
          <span>
            <span>
              <span>Caring for your furry friends</span>
              <span><span v-html="raw1sis"></span></span>
            </span>
            <span>
              <span><span v-html="rawznbn"></span></span>
              <span><span v-html="rawksgs"></span></span>
            </span>
          </span>
          <span>
            <span>
              <span><span v-html="rawdhhu"></span></span>
              <span><span v-html="rawszzz"></span></span>
            </span>
            <span>
              <span><span v-html="rawh591"></span></span>
              <span><span v-html="raws6fs"></span></span>
            </span>
          </span>
        </span>
      </div>
    ...
    <div class="role-play-list-container3">
      ...
      <router-link to="/menu" class="role-play-list-navlink1 button">
        Menu
      </router-link>
    </div>
    <div class="role-play-list-hero1 heroContainer">
      <h1 class="role-play-list-hero-heading1">
        <span class="heading1">Choose a Job</span>
        <br />
      </h1>
    ...
    <div class="role-play-list-footer">
      <footer class="role-play-list-footer1 footerContainer">
        <div class="role-play-list-container5">
          <router-link to="/" class="role-play-list-logo2 logo">
            PETCLINICMOCK
          </router-link>
        </div>
