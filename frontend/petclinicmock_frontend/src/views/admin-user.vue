<template>
  <div class="admin-user-container">
    <div class="admin-user-header">
      ...
      >
        <router-link to="/" class="admin-user-logo logo">PETCLINICMock</router-link>
        <div data-thq="thq-navbar-nav" class="admin-user-desktop-menu">
          ...
          ></div
        ><div data-thq="thq-burger-menu" class="admin-user-burger-menu"
          ><svg viewBox="0 0 1024 1024" class="admin-user-icon socialIcons">
            <path
              d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"
            ></path></svg></div
        ><div
          data-thq="thq-mobile-menu"
          class="admin-user-mobile-menu1 mobileMenu"
          ><div class="admin-user-nav"
            ><div class="admin-user-top"
              ><span class="logo">PETSCLINIC</span
              ><div data-thq="thq-close-menu" class="admin-user-close-menu"
                ><svg
                  viewBox="0 0 1024 1024"
                  class="admin-user-icon02 socialIcons"
                >
                  <path
                    d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"
                  ></path></svg></div></div
            ><nav class="admin-user-links"
              ><span class="admin-user-nav12 bodySmall">Home</span
              ><span class="admin-user-nav22 bodySmall">Services</span
              ><span class="admin-user-nav32 bodySmall">Our Team</span
              ><span class="admin-user-nav42 bodySmall">Contact</span></nav
          ...
          ><div
            ><svg
              ...
              class="admin-user-icon04 socialIcons"
            >
              <path
            ...
            ><svg
              ...
              class="admin-user-icon06 socialIcons"
            >
              <path
            ...
            ><svg
              ...
              class="admin-user-icon08 socialIcons"
            >
              <path
    ...
    ><div class="admin-user-footer"
      ><footer class="admin-user-footer1 footerContainer"
        ><div class="admin-user-container08"
          ><router-link to="/" class="admin-user-logo2 logo"
