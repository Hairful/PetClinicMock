  ...
  <div class="admin-case-study-detail-container">
    ...
    <div class="admin-case-study-detail-hero heroContainer">
      <div class="admin-case-study-detail-container03">
        ...
        <span class="admin-case-study-detail-hero-sub-heading bodyLarge">
          <span>
            <span>
              <span>Caring for your furry friends</span>
              <span><span v-html="rawv73j"></span></span>
            </span>
            <span>
              <span><span v-html="rawu3bc"></span></span>
              <span><span v-html="rawb03w"></span></span>
            </span>
          </span>
          <span>
            <span>
              <span><span v-html="rawpcyx"></span></span>
              <span><span v-html="rawym07"></span></span>
            </span>
            <span>
              <span><span v-html="rawbprc"></span></span>
              <span><span v-html="rawxc41"></span></span>
            </span>
          </span>
        </span>
      </div>
