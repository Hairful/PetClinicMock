    ...
    <div class="menu-header">
      ...
      >
        ...
        <div data-thq="thq-burger-menu" class="menu-burger-menu">
          <svg viewBox="0 0 1024 1024" class="menu-icon socialIcons">
            <path
              d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"
            ></path>
          </svg>
        </div>
        <div data-thq="thq-mobile-menu" class="menu-mobile-menu1 mobileMenu">
          <div class="menu-nav">
            <div class="menu-top">
              <span class="logo">PETSCLINIC</span>
              <div data-thq="thq-close-menu" class="menu-close-menu">
                <svg viewBox="0 0 1024 1024" class="menu-icon02 socialIcons">
                  <path
            ...
            <nav class="menu-links">
              <span class="menu-nav12 bodySmall">Home</span>
              <span class="menu-nav22 bodySmall">Services</span>
              <span class="menu-nav32 bodySmall">Our Team</span>
              <span class="menu-nav42 bodySmall">Contact</span>
            </nav>
      ...
      <div class="menu-hero1 heroContainer">
        <div class="menu-container2">
          <h1 class="menu-hero-heading">
            <span class="heading1">MENU</span>
            <br />
          </h1>
          <span class="menu-hero-sub-heading bodyLarge">
            <span>
              <span>
                <span>Caring for your furry friends</span>
                <span><span v-html="raw7gax"></span></span>
              </span>
              <span>
                <span><span v-html="rawlnc5"></span></span>
                <span><span v-html="raw8596"></span></span>
              </span>
            </span>
            <span>
              <span>
                <span><span v-html="rawz9m5"></span></span>
                <span><span v-html="rawbw8i"></span></span>
              </span>
              <span>
                <span><span v-html="rawvvcl"></span></span>
                <span><span v-html="rawgz4k"></span></span>
              </span>
            </span>
          </span>
        </div>
        <div class="menu-container3">
          <div class="menu-container4">
            <router-link to="/virtual-tour" class="menu-navlink button">
              <span class="heading3">
                <span>3D Virtual Tour</span>
                <br />
              </span>
            </router-link>
            <router-link to="/role-play-menu" class="menu-navlink1 button">
              <span class="heading3">
                <span>Role Play</span>
                <br />
              </span>
          ...
          <div class="menu-container5">
            <router-link to="/case-study-menu" class="menu-navlink2 button">
              <span class="heading3">
