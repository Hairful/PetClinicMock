<template>
  <div class="login-admin-container">
    <div class="login-admin-header">
      ...
      >
        <router-link to="/" class="login-admin-logo logo">
          PETCLINICMock
        </router-link>
        ...
        <div data-thq="thq-burger-menu" class="login-admin-burger-menu">
          <svg viewBox="0 0 1024 1024" class="login-admin-icon socialIcons">
            <path
        ...
        <div
          ...
          class="login-admin-mobile-menu1 mobileMenu"
        >
          <div class="login-admin-nav">
            <div class="login-admin-top">
              <span class="logo">PETSCLINIC</span>
              <div data-thq="thq-close-menu" class="login-admin-close-menu">
                <svg
                  viewBox="0 0 1024 1024"
                  class="login-admin-icon02 socialIcons"
                >
                  <path
            ...
            <nav class="login-admin-links">
              <span class="login-admin-nav12 bodySmall">Home</span>
              <span class="login-admin-nav22 bodySmall">Services</span>
              <span class="login-admin-nav32 bodySmall">Our Team</span>
              <span class="login-admin-nav42 bodySmall">Contact</span>
            </nav>
            <div class="login-admin-buttons1">
          ...
          <div>
            <svg
              ...
              class="login-admin-icon04 socialIcons"
            >
              <path
            ...
            ><svg
              ...
              class="login-admin-icon06 socialIcons"
            >
              <path
            ...
            ><svg
              ...
              class="login-admin-icon08 socialIcons"
            >
              <path
    ...
    <div class="login-admin-hero">
      <div class="login-admin-hero1 heroContainer">
        <div class="login-admin-container1">
          <h1 class="login-admin-hero-heading heading1">LOGIN (ADMIN)</h1>
          <h1 class="login-admin-hero-heading1 heading1">Welcome Back!</h1>
          <span class="login-admin-hero-sub-heading bodyLarge">
            <span>
              <span>
                <span>Caring for your furry friends</span>
                <span><span v-html="rawzf0v"></span></span>
              </span>
              <span>
                <span><span v-html="rawn5d7"></span></span>
                <span><span v-html="rawh4sd"></span></span>
              </span>
            </span>
            <span>
              <span>
                <span><span v-html="rawzj05"></span></span>
                <span><span v-html="raw307d"></span></span>
              </span>
              <span>
                <span><span v-html="rawp772"></span></span>
                <span><span v-html="rawtc8m"></span></span>
              </span>
            </span>
          </span>
        </div>
        <form class="login-admin-form">
          ...
          />
          <button class="login-admin-register2 buttonFilled">Register</button>
        </form>
      </div>
    </div>
    <div class="login-admin-footer">
      <footer class="login-admin-footer1 footerContainer">
        <div class="login-admin-container2">
          <router-link to="/" class="login-admin-logo2 logo">
            PETCLINICMOCK
          </router-link>
        </div>
