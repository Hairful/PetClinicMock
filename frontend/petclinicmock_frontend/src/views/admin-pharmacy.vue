<template>
    <div class="admin-pharmacy-container">
        <div class="admin-pharmacy-header">
            <header
            data-thq="thq-navbar"
            class="navbarContainer admin-pharmacy-navbar-interactive"
            >
        ...
        <div class="admin-pharmacy-hero1 heroContainer">
          <div class="admin-pharmacy-container05">
            ...
            <textarea style="width: 700px; height: 60px;" v-model="newMed.medicineIntro" placeholder="添加药品描述" class="textarea"></textarea>
        ...
        <div class="admin-pharmacy-container07">
          <ul class="admin-pharmacy-ul list">
            <li class="admin-pharmacy-li list-item Content" v-for="(medicine, index) in medicines" :key="medicine.medicineID">
              <div class="admin-pharmacy-container08">
                ...
                <textarea style="width: 700px; height: 60px;" v-model="medicine.medicineIntro" placeholder="修改药品描述" class="textarea"></textarea>
      ...
      <div class="admin-pharmacy-footer">
        ...
        <div class="admin-pharmacy-container10"><router-link to="/menu" class="admin-pharmacy-logo2 logo">PETCLINICMOCK</router-link></div>
        <div class="admin-pharmacy-separator"></div>
        <div class="admin-pharmacy-container11"><span class="bodySmall admin-pharmacy-text21">© 2024 SWD-G02, All Rights Reserved.</span></div>
        </footer>
      </div>
    </div>
  </template>
