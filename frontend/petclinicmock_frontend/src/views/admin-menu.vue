<template>
  <div class="admin-menu-container">
    <div class="admin-menu-header">
      ...
      >
        <router-link to="/" class="admin-menu-logo logo">
          PETCLINICMock
        </router-link>
        ...
        <div
          ...
          class="admin-menu-mobile-menu1 mobileMenu"
        >
          <div class="admin-menu-nav">
            <div class="admin-menu-top">
              <span class="logo">PETSCLINIC</span>
              <div data-thq="thq-close-menu" class="admin-menu-close-menu">
                <svg
                  viewBox="0 0 1024 1024"
                  class="admin-menu-icon02 socialIcons"
                >
                  <path
            ...
            <nav class="admin-menu-links">
              <span class="admin-menu-nav12 bodySmall">Home</span>
              <span class="admin-menu-nav22 bodySmall">Services</span>
              <span class="admin-menu-nav32 bodySmall">Our Team</span>
              <span class="admin-menu-nav42 bodySmall">Contact</span>
            </nav>
          ...
          <div>
            <svg
              ...
              class="admin-menu-icon04 socialIcons"
            >
              <path
            ...
            ><svg
              ...
              class="admin-menu-icon06 socialIcons"
            >
              <path
            ...
            ><svg
              ...
              class="admin-menu-icon08 socialIcons"
            >
              <path
    ...
    <div class="admin-menu-hero">
      <div class="admin-menu-hero1 heroContainer">
        <div class="admin-menu-container2">
          ...
          <span class="admin-menu-hero-sub-heading bodyLarge">
            <span>
              <span>
                <span>Caring for your furry friends</span>
                <span><span v-html="raw6qpn"></span></span>
              </span>
              <span>
                <span><span v-html="rawuosz"></span></span>
                <span><span v-html="raw5klp"></span></span>
              </span>
            </span>
            <span>
              <span>
                <span><span v-html="rawrxqo"></span></span>
                <span><span v-html="raw7b52"></span></span>
              </span>
              <span>
                <span><span v-html="rawi76z"></span></span>
                <span><span v-html="rawufkj"></span></span>
              </span>
            </span>
          </span>
        </div>
    ...
    <div class="admin-menu-footer">
      <footer class="admin-menu-footer1 footerContainer">
        <div class="admin-menu-container6">
          <router-link to="/" class="admin-menu-logo2 logo">
            PETCLINICMOCK
          </router-link>
        </div>
        <div class="admin-menu-separator"></div>
        <div class="admin-menu-container7">
          <span class="bodySmall admin-menu-text29">
...
export default {
  ...
  metaInfo: {
    title: 'AdminMenu - Roasted Rusty Swallow',
    meta: [
      {
        property: 'og:title',
        content: 'AdminMenu - Roasted Rusty Swallow',
      },
    ],
  },
}
