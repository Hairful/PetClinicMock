<template>
  <div class="quiz-result-container">
    <div class="quiz-result-header">
      ...
      >
        <router-link to="/" class="quiz-result-logo logo">
          PETCLINICMock
        </router-link>
        ...
        <div data-thq="thq-burger-menu" class="quiz-result-burger-menu">
          <svg viewBox="0 0 1024 1024" class="quiz-result-icon socialIcons">
            <path
        ...
        <div
          ...
          class="quiz-result-mobile-menu1 mobileMenu"
        >
          <div class="quiz-result-nav">
            <div class="quiz-result-top">
              <span class="logo">PETSCLINIC</span>
              <div data-thq="thq-close-menu" class="quiz-result-close-menu">
                <svg
                  viewBox="0 0 1024 1024"
                  class="quiz-result-icon02 socialIcons"
                >
                  <path
            ...
            <nav class="quiz-result-links">
              <span class="quiz-result-nav12 bodySmall">Home</span>
              <span class="quiz-result-nav22 bodySmall">Services</span>
              <span class="quiz-result-nav32 bodySmall">Our Team</span>
              <span class="quiz-result-nav42 bodySmall">Contact</span>
            </nav>
          ...
          <div>
            <svg
              ...
              class="quiz-result-icon04 socialIcons"
            >
              <path
            ...
            ><svg
              ...
              class="quiz-result-icon06 socialIcons"
            >
              <path
            ...
            ><svg
              ...
              class="quiz-result-icon08 socialIcons"
            >
              <path
    ...
    <div class="quiz-result-hero heroContainer">
      <div class="quiz-result-container03">
        ...
        <span class="quiz-result-hero-sub-heading bodyLarge">
          <span>
            <span>
              <span>Caring for your furry friends</span>
              <span><span v-html="rawbwui"></span></span>
            </span>
            <span>
              <span><span v-html="rawv2mg"></span></span>
              <span><span v-html="raweg7j"></span></span>
            </span>
          </span>
          <span>
            <span>
              <span><span v-html="rawgj5l"></span></span>
              <span><span v-html="rawxrp3"></span></span>
            </span>
            <span>
              <span><span v-html="rawz3uo"></span></span>
              <span><span v-html="rawdbnz"></span></span>
            </span>
          </span>
        </span>
      </div>
    ...
    <div class="quiz-result-footer">
      <footer class="quiz-result-footer1 footerContainer">
        <div class="quiz-result-container13">
          <router-link to="/" class="quiz-result-logo2 logo">
            PETCLINICMOCK
          </router-link>
        </div>
