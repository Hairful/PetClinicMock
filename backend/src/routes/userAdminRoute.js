...
//启用Token认证
/*
router.get('', isTokenValid, isQueryValid(paramsInQueryOfList), getUserList);
router.post('', isTokenValid, isBodyValid(paramsInBodyOfCreat), createUser);
router.put('', isTokenValid, updateUser);
router.delete('', isTokenValid, isQueryValid(paramsInQueryOfDelete), deleteUser);
*/
